...
p1 <- map_counties(storm = "Floyd-1999", metric = "rainfall") +
  ggtitle("Floyd-1999") +
  theme(plot.title = element_text(size=rel(1.75),color = "blue",hjust = 0.5,face="bold.italic"),
        legend.title = element_text(face = "italic",colour = "blue"),
...
p2 <- map_rain_exposure(storm ="Allison-2001",
  ...
  theme(plot.title = element_text(size=rel(1.75),color = "#000080",hjust = 0.5,face="bold.italic"),
        legend.title = element_text(face = "bold",colour = "#000080"),
        legend.text = element_text(face = "bold",colour = "#000080"))
p2
...
p2_1 <- plot_usmap(data = rain_01, values = "rainfall", color = "grey", include = rain_01$fips) +
  geom_polygon( data=MainStates, aes(x=lon.1, y=lat.1, group=group),
                color="black",  size = 0.05, alpha = 0) +
  scale_fill_manual(values = c("#F7FBFF","#000080"), name = "Rainfall > 175mm") +
...
factpal <- colorFactor("Blues", shape$rainfall)
...
pal <- colorFactor("Blues", rain_01$rainfall)
